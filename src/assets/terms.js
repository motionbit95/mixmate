...
제 1조 목적
이 약관은 주식회사 세이프바운더리(이하 "회사")에서 제공하는 "디너메이트식사회"와 관련된 제반 서비스의 접속 및 이용에 필요한 권리 및 의무와 책임사항, 기타 필요한 사항을 규정하는 것을 목적으로 합니다.

제 2조 용어의 정의
서비스 : 개인용 컴퓨터 (PC), TV, 휴대형 단말기, 전기통신설비 등 포함 각종 유무선 장치와 같이 구현되는 단말기와 상관없이 회원이 이용할 수 있는 "디너메이트식사회" 관련 제반 서비스를 의미합니다.
...
중중단되는 서비스가 유료서비스인 경우, 회원이 유료서비스 이용 전 서비스 중단 시, 유료서비스를 위해 회사에 지급한 금액을 환불하며, 그 외 보상은 지급하지 않습니다. 
단되는 서비스가 유료서비스인 경우, 회원이 유료서비스를 위해 회사에 지급한 금액을 환불하며, 그 외 보상은 지급하지 않습니다. 
...
결제 및 정산과정은 아래와 같습니다.
매칭: 회사의 서비스를 유료로 이용하고자 하는 회원이 서비스를 통해 타 회원과 협의 후 동일한 식사일정을 진행하는데에 상호 합의합니다.
결제실행: 회사의 서비스를 유료로료 이용하고자 하는 회원이 서비스를 통해 이용대금을 결제합니다. 
...
기타 “디너메이트식사회” 서비스 목적에 맞지 않는 행위를 하는 경우
기타 "디너메이트식사회" 모바일 어플리케이션 또는 온라인 웹 페이지를 통하여 추가로 공지되는 사항에 위배되는 경우
