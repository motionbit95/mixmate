...
밥 친구 매칭 플랫폼 '식사회' 서비스를 운영하고 있는 (주)세이프바운더리 입니다. 

### 제 1조 목적

이 약관은 주식회사 세이프바운더리 (이하 “회사”)에서 제공하는 모바일 앱 또는 웹을 포함한 제반 서비스(이하 "서비스")에 접속과 사용자에 의해서 업로드 및 다운로드 되어 표시되는 모든 정보, 텍스트, 이미지 및 기타 자료를 이용하는 이용자(이하 "회원")와 서비스 이용에 관한 권리 및 의무와 책임사항, 기타 필요한 사항을 규정하는 것을 목적으로 합니다.
...
3. 본 약관에 명시되지 않은 사항이 관계법령에 규정되어 있을 경우에는 그 규정에 따릅니다.

### 제 4조 용어의 정의

1. 식사회: 밥친구 유저 매칭 등을 제공하는 서비스입니다.
2. 서비스: 개인용 컴퓨터 (PC), TV, 휴대형 단말기, 전기통신설비 등 포함 각종 유무선 장치와 같이 구현되는 단말기와 상관없이 회원이 이용할 수 있는 회사 및 회사 관련 제반 서비스를 의미합니다. 제반 서비스에는 개발자 및 서비스 제공자가 회사 Open Application Programming Interface 서비스와 이를 이용하여 개발한 API 응용 애플리케이션 또는 웹서비스도 포함됩니다.
3. 회원: 회사와 서비스 이용계약을 체결하고 회사가 제공하는 서비스를 이용하는 모든 사용자를 의미합니다.
4. 닉네임: 회원의 식별 및 서비스 이용을 위하여 회원이 선정한 이름을 의미합니다.
5. 비밀번호: 회원의 개인 정보 및 확인을 위해서 회원이 정한 문자 또는 숫자의 조합을 의미합니다.
6. 일정: 회원이 언제, 어디서 식사를 할지 짜 놓은 계획을 의미합니다.
7. 주변친구: 회원의 위치를 기준으로 가까운 거리의 다른 회원을 의미합니다.    
8. 매칭: 회원간 동의하에 채팅으로 일정을 동일시 하는 행위를 의미합니다.
9. 채팅: 매칭 신청 후 결제 완료 된 회원간 자동 생성되는 대화방을 의미합니다.
10. 대기일정: 회원이 설정한 일정이 생성되고 아직 매칭되지 않은 일정을 의미합니다.
11. 매칭일정: 회원이 설정한 일정이 생성되고 다른 회원과 매칭된 일정을 의미합니다.
12. 지난일정: 날짜가 지난 모든 일정을 의미합니다.
13. 프로필: 회원의 사진, 메모, 식사 가능 동네, 좋아하는 음식, 나이, 취미 등 회원을 어필 할 수 있는 정보가 있는 페이지를 의미합니다.
14. 게시물: 회원이 서비스를 이용함에 있어 회원이 서비스에 게시한 문자, 문서, 그림, 음성, 링크, 파일 혹은 이들의 조합으로 이루어진 정보 등 모든 정보나 자료를 의미합니다.
16. 유료서비스: 회사가 유료로 제공하는 각종 제반 서비스를 의미합니다.
17. 포인트: 회사의 유료 콘텐츠를 이용하기 위해 회원이 구입하는 사이버 머니를 말합니다.
18. 중개서비스: 회사가 식사회 사이트와 모바일 식사회를 통하여 회원들에게 제공하는 회원 간의 중개서비스 및 관련 부가서비스 일체를 말합니다.
19. 전자지급결제대행서비스: 회원이 서비스를 이용할 시, 회원이 신용카드 및 다양한 결제수단을 이용하여 안전하게 결제할 수 있도록 지원하는 서비스입니다.
20. 이 약관에서 사용하는 용어 중 위에서 정하지 아니한 것은, 관계법령 및 서비스별 안내에서 정하는 바에 따르며, 그 외에는 일반 거래관행에 따릅니다.

### 제 5조 이용계약의 체결

1. 이용계약은 회원이 회사 서비스 및 제반 서비스에서 제공하는 회원 가입 페이지에서 서비스 이용약관에 동의한 후 이용신청을 하고 신청한 내용에 대해서 회사가 승낙함으로써 체결됩니다. 필요한 경우 회사는 본인 확인 기관을 통한 실명확인 및 본인인증을 요청할 수 있습니다.
2. 회사는 이용약관에 동의한 후 이용 신청한 사용자에 대해서 원칙적으로 접수 순서에 따라 서비스 이용을 승낙함을 원칙으로 합니다. 다만 업무 수행상 또는 기술상 지장이 있을 경우 일정시간 가입승인을 유보할 수 있습니다.
...
1. 회사는 회원에 대해 회사정책에 따라 등급별로 구분하여 이용시간, 이용횟수, 서비스 메뉴 등을 세분하여 이용에 차등을 둘 수 있습니다.
2. 회원은 회사에 언제든지 회원 탈퇴를 요청하여 이용계약을 해지할 수 있습니다.
3. 회원은 회원 가입 시 기재한 개인정보의 내용에 변경이 발생한 경우, 즉시 변경사항을 정정하여 기재하여야 합니다. 변경의 지체로 인하여 발생한 회원의 손해에 대해 회사는 책임을 지지 않습니다.
4. 회사는 관련 법률 및 회사의 개인정보취급방침에서 정한 바에 따라 회원에게 요청하는 회원정보 및 기타정보 항목을 추가, 삭제 등 변경하여 수집 및 이용할 수 있습니다.
...
3. 회사는 서비스 개선 및 회원 대상의 서비스 소개 등의 목적으로 회원의 동의하에 관계 법령에서 정하는 바에 따라 추가적인 개인정보를 수집할 수 있습니다.
...
3. 회사는 서비스를 이용하는 회원으로부터 제기되는 의견이나 불만이 정당하다고 인정할 경우를 이를 처리하여야 합니다. 이때 처리과정에 대해서 고객에게 메일 및 게시판 등의 방법으로 전달합니다.
...
1. 회원은 다음 각호에 해당하는 행위를 해서는 안됩니다.
  ...
  - 회사의 서면허가를 받은 경우를 제외하고 회사가 제공하는 소프트웨어의 일부를 복사, 수정, 배포, 판매 또는 대여가 불가능하고 역설계하거나 소스 코드의 추출을 시도하는 등 회사의 서비스를 복제, 분해하거나 기타 변형하는 행위
  ...
  - 자동 접속 프로그램 등을 사용하는 등 정상적인 용법과 다른 방법으로 서비스를 이용하여 회사의 서버에 부하를 일으켜 회사의 정상적인 활동을 방해하는 행위
...
4. 회사는 회원과 별도로 서면 계약을 체결하여 회사 서비스 및 제반 서비스의 브랜드 특성을 이용할 수 있는 명시적인 권리를 부여하지 아니하는 한, 회원에게 회사 또는 서비스의 상호, 상표, 서비스표, 로고, 도메인 네임 및 기타 식별력 있는 브랜드 특성을 이용할 수 있는 권리를 부여하지 않습니다.
5. 회사가 제공하는 서비스의 형태와 기능, 디자인 등 필요한 경우 수시로 변경되거나, 중단될 수 있습니다. 회사는 이 경우 개별적인 변경에 대해서 회원에게 사전 통지하지 않습니다. 다만, 회원에게 불리한 것으로 판단되는 경우 전자우편으로 통하여 이를 공지합니다.
6. 회사가 제공하는 유료서비스는 밥 친구 매칭 신청입니다.
7. 전항에 의해서 제공되는 서비스가 변경 및 중단될 경우 서비스에 대해서는 회원에게 유료서비스 매칭 신청 결제 외 별도로 보상하지 않습니다.
8. 회사내의 콘텐츠가 저작권자와의 계약 종료 등으로 그 내용이 변경되는 경우에는 장차 체결되는 계약에 의해 제공할 컨텐츠의 내용을 변경할 수 있습니다. 이 경우에는 변경된 콘텐츠의 내용 및 제공 일자를 명시하여 현재 콘텐츠의 내용을 게시한 곳에 즉시 공지합니다.
...
4. 회사가 본 약관 제9조의 위반 행위를 조사하는 과정에서 당해 회원 ID및 도메인이 특정 위반행위에 직접적으로 관련되어 있는 경우 등 다른 회원의 권익 보호 및 서비스의 질서유지를 위해 불가피할 경우에는 해당 ID 및 도메인의 이용을 일시적으로 정지할 수 있습니다. 이에 대해 회원은 서비스 홈페이지 또는 전자 우편 등을 통해 이의신청을 할 수 있습니다.
...
4. 회원은 자신이 서비스 내에 게시한 게시물을 회사가 국내ㆍ외에서 다음 목적으로 사용하는 것을 허락합니다.
...
1. 회원은 회사가 제공하는 절차에 의하여 재화, 콘텐츠 구매를 신청할 수 있으며, 아래 사항을 각 재화 및 콘텐츠 또는 관련 게시물에 표시합니다.
2. 재화, 콘텐츠의 명칭, 종류, 내용, 가격, 연령 제한
3. 회원은 회사에서 정하고 있는 방법으로 유료서비스의 결제가 가능합니다. 단, 미성년 회원의 결제는 원칙적으로 보호자(법정대리인)의 명의 또는 동의하에 이루어져야 하고, 보호자(법정대리인)는 본인 동의 없이 체결된 자녀(미성년자)의 계약을 취소할 수 있습니다.

### 제 18조 청약 철회의 효과 및 환불

1. 회사의 귀책사유로 회원이 유료서비스를 이용할 수 없게 된 경우, 회사는 회사의 귀책범위 내에서 환불하거나 결제를 취소합니다.
2. 회원이 청약철회 또는 환불을 한 경우 회사는 포인트를 회수 또는 삭제하고, 포인트를 회수 또는 삭제한 날로부터 3영업일 이내에 지급받은 대금과 동일한 방법으로 이를 환급합니다. 동일한 방법으로 환급이 불가능할 때에는 회사가 사전에 고지한 방법으로 환불 처리합니다.
3. 이 경우 회사가 회원에게 환급을 지연한 때에는 그 지연기간에 대하여 전자상거래 등에서의 소비자 보호에 관현 법률 및 시행령에서 정하는 이율을 곱하여 산정한 지연이자를 지급합니다.

### 제 19조 과오금

1. 회사는 과오금이 발생한 경우 회원이 결제한 방법과 동일한 방법으로 환불하며, 동일한 방법으로 환불이 불가능할 때에는 이를 사전에 고지합니다.
2. 회사의 책임이 있는 사유로 과오금이 발생한 경우에는 과오금 전액을 환불하며, 회원의 책임이 있는 사유로 과오금이 발생한 경우, 회사가 과오금을 환불하는데 소요되는 비용은 합리적인 범위 내에서 회원이 부담하여야합니다.
3. 회사는 회원이 과오금을 주장하여 환불을 요구하는 경우, 정당하게 유료서비스 요금이 부과되었음을 입증하면 환불을 거부할 수 있습니다.
4. 회사는 과오금의 환불절차를 콘텐츠 이용자보호지침에 따라 처리합니다.
...
1. 본 약관은 2024년 01월 16일에 제정되었습니다.
2. 본 약관은 2024년 01월 22일부터 시행됩니다.
`;
