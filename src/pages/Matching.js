...
◆매칭 신청자
매칭 신청 및 결제 - 채팅으로 식사 또는 커피 약속 잡기 - 접선
-결제된 매칭권 사용기한은 2주
-상대방이 매칭 거절 또는 채팅 미응답 시 전액 환불

◆매칭 수락자
수락 또는 거절 - 수락 시 채팅으로 식사 또는 커피 약속 잡기 - 접선 - 매칭 대금 정산
-수락자 본인이 설정한 매칭권 금액의 30%의 매칭 플랫폼 수수료 제외 후 정산
-정산은 접선 완료 인증 후 2영업일 내에 기재해주신 수락자 계좌로 정산
`}
                      </Text>
                    </Stack>
                    <HStack w="100%">
